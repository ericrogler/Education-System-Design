...
After the first week, which may be chaotic, the goal is putting together and finding resources you'll use often throughout the teaching period. This may still require some time outside of work to complete.

If there's items from week 1 not complete, then get those done as soon as possible.

## **Long Answer**

Things get easier after week 1 and the next challenge is making it through month 1, assuming you kept to the classroom management plan and ensured troublemaker's actions saw the appropriate consequences. 

If week 1 was setting up the foundation, then month 1 is consolidating and sorting the resources needed to build up and maintain a functioning classroom.
...
## **[Next Chapter](Z024_Action_Plan_Year_1.html)**
...
Another way to decrease funding through enrollment numbers, and impact any education systems reliant upon enrollment-based funding, is for parents and students themselves to withdraw from these systems. This could take many forms, such as homeschooling, co-ops, and informal groupings of students outside of traditional setups like some public and private schools. As those students leave a system, the number of enrolled students drops. Since enrollment numbers are down, the amount of funding provided also decreases, which means lower resources available for students, staff, and more from the education systems fallout and more students considering departing as well.

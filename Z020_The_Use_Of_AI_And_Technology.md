...
As for technology, we have advanced far and wide to do things we never could've done before in the past, but we also risk losing the nuance for how and why things work "under the hood." There's also a lot of ways to abuse, exploit, and use technology for less-than-good purposes, despite whatever guardrails you may implement.
- E.g. Deferring all of your thinking to an AI or any piece of technology may make you replaceable as a result.
...
Maybe alluding to *Fahrenheit 451* by Ray Bradbury (1953) is the way to start this section.
...
You may find many people desire a better quality of life, or improved standard of living, which leads to an increased desire to protect what they already have while also detesting anything that threatens to worsen it. Technology can provide better solutions to problems, but also generate new problems. 

For example, say it takes at most 1-2 seconds to load a website, but today you noticed it's taking over 1 minute to load. In this scenario, newer and better technology established a new baseline you come to expect. Any impatience and misery is "manufactured" and shaped by the environment and technology you're accepted as your new normal. That same impatience may win against your tolerance and you swap over to do something else rather than deal with the vulnerabilities and negative effects associated with issues like these.
...
To give an example of this permeation: a school may provide every student with their own personal electronic device (or similar, future technology). It may have the following features:
...
As another example of human engineering: there's a possibility you have security systems up-to-date and ready to defend against intrusions, but an employee's computer got breached because they did one tiny mistake and now there's an open door into every other system ripe for the taking.
...
If you ever create and/or design something and have even the slightest concern about security risks, then design it as if an attacker was already inside or anyone accessing it can compromise it.
...
As for how you can address these threats to security, it depends on what the threat is (i.e. the threat model) and the type of target. A government agency with the full force of the law on its side is usually far more capable of breaking through many systems compared to your average person off the street. Conversely, any random person, such as a pickpocket on the street, is far more likely to try and break through your security measures despite their reduced functionality. You could also be a specific target worth dedicating resources to or simply one of millions of targets caught in the crossfire. The full exploration of these concepts beyond actors and target types is far beyond the scope of this book, however.

While you may be someone who knows *how* to fix these issues yourself and troubleshoot problems, that doesn't necessarily earn you the "key" to do so. It does, however, let you avoid significant frustration with any IT or system administrative personnel because you can clearly state you have X problem, know the solution is Y, and only clarify what other steps and permissions are needed for it.
...
What was a strategy for survival in medieval times translates to a general risk mitigation strategy in modern times.
...
That includes AI (artificial intelligence) you deploy and allow to make its own choices. I include *anyone,* including managers, executives, and non-technical personnel, that handles or modifies deliverables (including "code" for software) is now on-call and owns incident remediation and responsibility for anything they ship out. It also includes owning the costs behind utilizing AI as a means to replace "human" labor in favor of technology doing that labor instead.
...
**If you cannot confidently answer these questions, that's OK, but I will say you shouldn't incorporate AI yet. If you do have solid answers, that's good.** Your answers may also differ depending on your situation.
...
AI also cannot understand like a human can. Overdependence on AI by humans breeds normalized incompetence, which will be a rapidly growing problem alongside ever-growing costs as data complexity increases and the cost of resources AI needs increases. It can generate answers like a human can, which means it can generate *incorrect* answers and slip up like a human can too. Taking everything it says purely at face value without thinking it through is putting yourself on the highway to incompetence.
...
The other major cost with AI, and many other technologies, is the amount of capital expenses (i.e. initial investment) and operating expenses (e.g. labor and maintenance) required. For AI specificially, you may need to purchase servers, processing units, and real estate to host the equipment as well as recruit staff to maintain the systems, oversee policies around its deployment, and administer its usage.
...
If you ever implement automation, AI, LLMs, etc. they should be used only for operations where its benefit outruns any present and potential future cost. If not, you risk spiraling into a financial deficit through reckless use of technology and needlessly affect the lives of people as well.

Even if costs aren't an issue, we still have a knowledge and *human* problem to address. Overusing technology to replace human skills results in atrophy of those skills. For example, overusing AI to make decisions for us robs us of the ability of critical thinking and how to make decisions for ourselves.
...
Automation, scripts, or macros may achieve similar results at far cheaper costs and lower error rates compared to any AI solution. That's one of many reasons you don't need to use AI and may need better processes instead of new technology.

Here are some examples I've seen myself in practice regarding AI inside education systems:
...
As a stern reminder, anything listed under "Allowed AI Use" should require a human to verify its accuracy and ensure the intended outcome(s). You may get reprimanded for producing bad outputs even if AI is used to help you. Technology, including AI, should be viewed primarily as a way to speed up doing things you already know how to do here.

### **Potential Solution(s) to AI in Education**

As a reminder, AI can do some tasks really well and other tasks it flops down like a sad pancake on a griddle. If anything, it may make educators go *more* analog and outright avoid its implementation if feasible.

If a AI writes your essay or does an assignment in general for you, it's called cheating and academic dishonesty. You're claiming you did the work, despite another entity actually doing it for you instead. It can also make 10+ students give out the exact same answers, word-for-word, on their essays which are later reviewed and graded by education professionals. It does make homework and other assignments done outside-of-class much harder to verify the integrity of, but the quality is still questionable.

Cheating, "laziness," and academic dishonesty were *never* exclusive to, or purely a result of, AI either. Technology changes, but behavior remains pretty consistent here. This goes all the way back to ancient Greece, encyclopedias around the 1500s, Wikipedia, SparkNotes, and Google in the 2000s, and Stack Overflow in the late 2000s and 2010s. A person will naturally "optimize" to find simpler and easier ways to do things over time, even if the motivation isn't laziness but instead working smarter instead of harder. Goodhart's Law also incentivizes cheating, since when you make a measure a target, students may focus on reaching that target instead of any learning involved along the way. Therefore, assuming the "metric" is a grade, score, etc., **if students can get away with any form of cheating to earn a high grade, pass a test, etc., they will do it. Cheating has always happened, and will continue to happen, regardless of ANY technology.**
